...
TOKEN = os.getenv('6756198918:AAFcV7AdOZymndu8Uc7FyBc9lQnEgw_TEJc')
OWNER_ID_STR = os.getenv('2031314339')
ADMIN_ID_STR = os.getenv('2031314339')
YOUR_USERNAME = os.getenv('tera_paglu')
UPDATE_CHANNEL = os.getenv('source_code_4web')
...
YOUR_USERNAME = YOUR_USERNAME or '@tera_paglu'
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/source_code_4web'
